...
export const convTranspose2dNode: NodeDefinition = {
  ...
  learnMore:
    'The "reverse" of Conv2d \u2014 increases spatial resolution instead of decreasing it. Used in decoder networks (autoencoders, GANs, segmentation) to upsample feature maps back to image size. Also called "deconvolution" though that term is technically incorrect.',
  ...
  getProperties: () => [
    ...
    },
    {
      ...
      defaultValue: 3,
      affects: 'execution',
      help: 'Size of the upsampling filter.',
    },
    {
      id: 'stride',
      name: 'Stride',
      ...
      defaultValue: 1,
      affects: 'execution',
      help: 'Upsampling factor. Stride 2 doubles spatial dimensions.',
    },
    {
      id: 'padding',
      name: 'Padding',
      ...
      defaultValue: 0,
      affects: 'execution',
      help: 'Controls output size. With kernel=4, stride=2, padding=1: output = 2x input size.',
    },
    {
      id: 'outputPadding',
      name: 'Output Padding',
      ...
      defaultValue: 0,
      affects: 'execution',
      help: 'Extra padding on one side to resolve ambiguous output sizes. Usually 0.',
    },
  ],
