...
export const adaptiveAvgPool2dNode: NodeDefinition = {
  ...
  learnMore:
    'Pools to a fixed output size regardless of input size. Commonly used as the last pooling layer to produce a consistent size before the classifier, no matter what the input resolution is.',
