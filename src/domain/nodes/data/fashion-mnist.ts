...
export const fashionMnistNode: NodeDefinition = {
  ...
  category: ['Data', 'Image'],
  learnMore:
    'A harder drop-in replacement for MNIST with the same format (28\u00d728 grayscale, 10 classes). Contains clothing items instead of digits. More challenging because the visual differences between classes are subtler (shirts vs coats, sneakers vs boots).',
