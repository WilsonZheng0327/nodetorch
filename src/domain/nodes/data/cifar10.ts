...
export const cifar10Node: NodeDefinition = {
  ...
  category: ['Data', 'Image'],
  learnMore:
    'Ten classes of small color photographs (airplane, car, bird, cat, deer, dog, frog, horse, ship, truck). 32\u00d732 RGB images \u2014 much harder than MNIST because of complex backgrounds, varying poses, and color. A standard benchmark for CNN architectures.',
