...
export const sigmoidNode: NodeDefinition = {
  ...
  learnMore:
    'Squashes any value to the range (0, 1). Useful as the final activation for binary classification or when you need probabilities. Can cause vanishing gradients in deep networks because the gradient is very small for large/small inputs.',
